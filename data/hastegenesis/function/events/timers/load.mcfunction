...
scoreboard objectives add hastegenesis_set_vigor_gem_right_click_cooldown trigger
scoreboard objectives add hastegenesis_set_life_gem_right_click_cooldown trigger
scoreboard objectives add hastegenesis_set_stellar_gem_right_click_cooldown trigger
scoreboard objectives add hastegenesis_set_placeholder_gem_right_click_cooldown trigger

scoreboard objectives add hastegenesis_set_pyro_gem_left_click_cooldown trigger
scoreboard objectives add hastegenesis_set_aqua_gem_left_click_cooldown trigger
scoreboard objectives add hastegenesis_set_bolt_gem_left_click_cooldown trigger
scoreboard objectives add hastegenesis_set_vigor_gem_left_click_cooldown trigger
scoreboard objectives add hastegenesis_set_life_gem_left_click_cooldown trigger
