execute if entity @s[tag=!hastegenesis_is_operator] run scoreboard players set @s hastegenesis_set_aqua_gem_right_click_cooldown 0
...
execute store result storage minecraft:hastegenesis aqua_gem_right_click_cooldown int 1 run scoreboard players get @s hastegenesis_set_aqua_gem_right_click_cooldown
