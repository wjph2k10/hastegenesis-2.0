...
execute store result storage hastegenesis stellar_gem_left_click_cooldown int 1 run scoreboard players get @s hastegenesis_set_stellar_gem_left_click_cooldown
