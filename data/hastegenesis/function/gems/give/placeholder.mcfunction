...
give @s minecraft:debug_stick[\
	\
	minecraft:item_model="hastegenesis:placeholder_gem",\
	\
	max_stack_size=1,\
	\
	tooltip_display=\
	...
	rarity=epic,\
	\
	custom_name=[{"text":"Placeholder","italic":false}],\
	\
	...
	lore=[\
		...
		[{"text":"Passive:","italic":false,"color":"#c0bfbc"}],[{"text":"Great for impersonating devs","italic":false,"color":"#77767b"}],\
