...
execute at @s run summon minecraft:armor_stand ~ 500 ~ {Invisible:1b,Tags:[hastegenesis_dummy],NoGravity:1b,Invulnerable:1b}
...
execute if score @n[tag=hastegenesis_dummy,type=minecraft:armor_stand] hastegenesis_roll_number matches 1 run scoreboard players set @s hastegenesis_gem_rolled 1
execute if score @n[tag=hastegenesis_dummy,type=minecraft:armor_stand] hastegenesis_roll_number matches 2 run scoreboard players set @s hastegenesis_gem_rolled 2
execute if score @n[tag=hastegenesis_dummy,type=minecraft:armor_stand] hastegenesis_roll_number matches 3 run scoreboard players set @s hastegenesis_gem_rolled 3
execute if score @n[tag=hastegenesis_dummy,type=minecraft:armor_stand] hastegenesis_roll_number matches 4 run scoreboard players set @s hastegenesis_gem_rolled 4
execute if score @n[tag=hastegenesis_dummy,type=minecraft:armor_stand] hastegenesis_roll_number matches 5 run scoreboard players set @s hastegenesis_gem_rolled 5
execute if score @n[tag=hastegenesis_dummy,type=minecraft:armor_stand] hastegenesis_roll_number matches 6 run scoreboard players set @s hastegenesis_gem_rolled 6
