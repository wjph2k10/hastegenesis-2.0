...
<font color=red><h1 align="center">This is all for latest snapshot (found in the github)</h1></font>
<font color=red><p align="center">(I'm writing this as I make the updates)</p></font>
...
| The **Aqua Gem** grants the player a passive increase in swimming speed and allows the player to breathe underwater, upon **Right Click**, if submerged in water, the player heals five health | ![aqua](https://cdn.modrinth.com/data/4v0Yvamm/images/8a0e1b3eeaba1d989fadd165ebbdf98a15ac6a3a.png) |
...
**<p align="center">Q: How do I change the cooldowns for the gems?</p>**
<p align="center">A: First, toggle your operator status (/function hastegenesis:toggle_is_operator), then you will have access to all the operator "/trigger" commands which includes cooldowns.</p>
